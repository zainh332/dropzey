<template>
  <footer class="footer" aria-labelledby="footer-heading">
            ...
            <div class="mt-10 md:mt-0">
              ...
              <div class="flex space-x-6 mt-6">
                <a
                  ...
                  :key="item.name"
                  :href="item.href"
                  class="text-[#395867] rounded-md bg-white hover:text-gray-400"
                >
    ...
    <div class="py-8 flex bg_gradient items-center justify-center">
      <div
        class="flex sm:flex-row flex-col sm:gap-0 gap-4 sm:divide-x-2 md:gird-cols-1 divide-white grid-cols-3"
      >
        <h1 class="text-center px-2 text-base text-white">© 2023 Dropzey</h1>
        <h1 class="text-center px-2 text-base text-white">Disclaimer</h1>
        <h1 class="text-center px-2 text-base text-white">
...
const navigation = {
  ...
  support: [
    ...
    { name: "GitHub", href: "https://github.com/zainh332/dropzey", newTab: true },
    // { name: "Partner", href: "#" },
  ...
  social: [
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/dropzeyofficial",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
            h("path", {
    ...
    {
      name: "GitHub",
      href: "https://github.com/zainh332/dropzey",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
            h("path", {
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@Dropzeyofficial",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
            h("path", {
    ...
    {
      name: "Medium",
      href: "https://medium.com/@dropzeyofficial",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
            h("path", {
...
<style scoped>
.footer {
  background: linear-gradient(108deg, #254f74 0%, #0e273d 100%);
}
.para {
