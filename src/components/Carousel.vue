<template>
  <swiper :slidesPerView="4" :spaceBetween="50" :navigation="true" :modules="modules" :breakpoints="{
    250: {
      slidesPerView: 1,
      spaceBetween: 20,
    },
          ...
          <div class="card">
            ...
            <div class="section2 flex my-6 items-center divide-x-2 justify-between">
              ...
              <div class="flex items-end flex-col w-[50%]">
                ...
                <div class="w-[50%] flex">
                  <p class="text-xs text-gray-500 font-medium text-left ml-auto">
                    WSL
                  </p>
                </div>
              </div>
...
.swiper-slide {
  ...
  border-radius: 8px;
  background: #fff;
  box-shadow: 0px 5px 5px 0px rgba(18, 50, 77, 0.15);
